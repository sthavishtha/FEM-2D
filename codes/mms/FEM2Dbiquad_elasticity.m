...
% -------------------------------------------------------------------------
% Features
% - implemented biquadratic shape functions
...
% LOCAL-TO-GLOBAL MAPPING  
    ...
    for j = 1 : ndof_per_n : n_y - ndof_per_n
        for i = 1 : ndof_per_n : n_x - ndof_per_n       
            ...
            EL_N(3,el)   =   GLINDEX(i,j + 2);
            EL_N(4,el)   =   GLINDEX(i + 1,j + 2);
            EL_N(5,el)   =   GLINDEX(i + 1,j + 1);  
            EL_N(6,el)   =   GLINDEX(i + 1,j);  
            EL_N(7,el)   =   GLINDEX(i + 2,j);
            EL_N(8,el)   =   GLINDEX(i + 2,j + 1);  
