...
% - biquadratic shape functions with 9 nodes/element
...
% LOCAL-TO-GLOBAL MAPPING  
    ...
    for i = 1 : ndof : n_y - ndof
        for j = 1 : ndof : n_x - ndof        
            ...
            EL_N(3,el)   =   GLINDEX(i + 2,j);
            EL_N(4,el)   =   GLINDEX(i + 2,j + 1);
            EL_N(5,el)   =   GLINDEX(i + 1,j + 1);  
            EL_N(6,el)   =   GLINDEX(i,j + 1);  
            EL_N(7,el)   =   GLINDEX(i,j + 2);
            EL_N(8,el)   =   GLINDEX(i + 1,j + 2);  
            EL_N(9,el)   =   GLINDEX(i + 2,j + 2);            
        end
    end
